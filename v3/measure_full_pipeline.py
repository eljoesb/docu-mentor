"""
measure_full_pipeline.py — Pipeline completo BGE-base + Ollama sobre las 21 queries.

Retrieval con BAAI/bge-base-en-v1.5 (copiado de v2.1/measure_bge.py)
+ generación con Ollama llama3.2:3b (copiado de v1/documentor.py).

Produce pipeline_results.jsonl con:
...
RESULTS_PATH = SCRIPT_DIR / "pipeline_results_v3b.jsonl"
...
def main():
    print("=" * 60)
    print(f"v3 measure_full_pipeline.py")
