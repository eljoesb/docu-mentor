"""
judge.py — LLM-as-judge (GPT-4o-mini) sobre hybrid_results de v4.2.

Solo retrieval (v4.2 no tiene generation).
Usa el mismo prompt de v4.1 para comparabilidad.

Uso:
    python v4.2/judge.py

Output: judge_retrieval.csv
"""
...
RESULTS_PATH = SCRIPT_DIR.parent / "v4.2" / "hybrid_results.jsonl"
