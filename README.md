...
**Hipótesis abiertas:**
- Hybrid search (BGE + BM25) para mejorar retrieval (7/21 con criterio estricto). v2 hybrid falló con MiniLM débil; con BGE como componente denso el régimen es diferente.
- LLM-as-judge para estabilizar métricas — la clasificación manual tiene varianza de ±9 queries sobre 21.
...
Python + scikit-learn + sentence-transformers (BAAI/bge-base-en-v1.5) + Ollama (llama3.2:3b local).
